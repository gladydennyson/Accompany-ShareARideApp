...
public class GroupPage extends AppCompatActivity {
    ...
    private FirebaseListAdapter<GroupActions> adapter;
   ...
   public String uniqueKey;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button createride =
                (Button) findViewById(R.id.createride);
        ...
        createride.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                FirebaseDatabase.getInstance()
                        ...
                        .child("ghat_rides")
                        .push()
                        .setValue(new GroupActions(1,
                                FirebaseAuth.getInstance()
                                        .getCurrentUser()
                                        .getDisplayName()),new DatabaseReference.CompletionListener() {
                            @Override
